    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">#TeamUula2017</a>
            </div>
...
<button onClick="postVote('ajax/votes.php', function(text){document.getElementById('votes').innerHTML=text })" "type="button" class="btn btn-lg btn-primary">Äänestä!</button>
                ...
                <div class="row">
                    ...
                    <div class="footer-col col-md-4">
                        ...
                        <ul class="list-inline">
                            <li>
                                <a href="https://www.facebook.com/windancepj" class="btn-social btn-outline"><i class="fa fa-fw fa-facebook"></i></a>
                            </li>
                            <!--
                            <li>
                    ...
                    <div class="footer-col col-md-4">
                        <h3>Milloin?</h3>
                        <p>7.12.2016 klo 15:15 alkaen</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>[Tähän kohtaan kuva Runnun lakin tipasta ja yleistä shittiä kiltahommista, tai pelkästään hallitushommista.]</p>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Toimarinakit</h2>
                            <hr class="star-primary">
                            <img src="img/graafikko.png" class="img-responsive img-centered" alt="">
                            <p>[Tai sitten erikseen tarkemmin nakeista]</p>
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Project Title</h2>
                            <hr class="star-primary">
                            <img src="img/portfolio/mib.png" class="img-responsive img-centered" alt="">
